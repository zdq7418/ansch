...
public class RenyuanFragment extends Fragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        receiver = new RenyuanFragment.MyReceiver();
        getActivity().registerReceiver(receiver, new IntentFilter("renyuanfragment"));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_renyuan, container, false);
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            RequestParams params = new RequestParams(StaticSource.SERVICE+StaticSource.FINDBUYKEY);
